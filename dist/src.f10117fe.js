...
/** @class */
function () {
  function Collection(rootUrl, desirealize) {
    this.rootUrl = rootUrl;
    this.desirealize = desirealize;
    this.users = [];
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (res) {
      res.data.forEach(function (el) {
        _this.users.push(_this.desirealize(el));
      });
    });
...
function () {
  ...
  Model.prototype.set = function (userData) {
...
/** @class */
function () {
  function Attributes(userData) {
    var _this = this;

    this.userData = userData;

    this.get = function (key) {
      return _this.userData[key];
    };
  }

  Attributes.prototype.set = function (propName) {
    Object.assign(this.userData, propName);
  };
...
function (_super) {
  ...
  User.buildUser = function (userObj) {
    return new User(new Attributes_1.Attributes(userObj), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(rootUrl));
  };

  User.buildUserCollection = function () {
    return new Collection_1.Collection(rootUrl, function (el) {
      return User.buildUser(el);
    });
  };
...
/** @class */
function () {
  function CollectionView(parent, collecton) {
    this.parent = parent;
  ...
  CollectionView.prototype.render = function () {
    ...
    for (var _i = 0, _a = this.collecton.users; _i < _a.length; _i++) {
      var model = _a[_i];
...
function () {
  ...
  View.prototype.bindEvents = function (fragment) {
    ...
    var _loop_1 = function _loop_1(eventKey) {
      ...
      fragment.querySelectorAll(elem).forEach(function (item) {
...
exports.View = View;
},{}],"src/views/UserView.ts":[function(require,module,exports) {
"use strict";
